...
namespace AccelByte.Extend.SimpleEOSMatchmaking.Server.Tests
{
    ...
    public class SessionCreatorTests
    {
        ...
        public async Task GetSessionAsync_WithNullMatch_ShouldThrowArgumentNullException()
        {
            ...
            var logger = loggerFactory.CreateLogger<EosSessionProvider>();
            ...
            var sessionCreator = new EosSessionProvider(logger, eosService);
    ...
    public class SessionCreatorIntegrationTests
    {
        ...
        private EosSessionProvider CreateSessionCreator()
        {
            ...
            var logger = loggerFactory.CreateLogger<EosSessionProvider>();
            return new EosSessionProvider(logger, _eosFixture.EOSService);
        }
